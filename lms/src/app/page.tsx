...
// Create a custom type for the decoded token
...
        setSuccess(true);
        ...
        // Use the custom type to assert the shape of the decoded token
        ...
        setTimeout(() => {
          ...
          switch (role) {
            case "admin":
              redirectPath = "dashboard/AdminDashboard";
              break;
            case "teacher":
              redirectPath = "dashboard/TeacherDashboard";
              break;
            case "student":
              redirectPath = "dashboard/StudentDashboard";
              break;
            default:
              redirectPath = "/";
          }
